...
class OpenGraphTest extends AbstractTestCase
{
    ...
    /**
     * Test method [parseOpenGraphMedia] with images.
     *
     * @return void
     */
    public function testParseOpenGraphMediaImage()
    {
        $openGraphData = $this->invokeMethod($this->scraper, 'getAllByNamespace', ['og']);
    ...
    /**
     * Test method [parseOpenGraphMedia] with videos.
     *
     * @return void
     */
    public function testParseOpenGraphMediaVideos()
    {
        $openGraphData = $this->invokeMethod($this->scraper, 'getAllByNamespace', ['og']);
        $this->invokeMethod($this->trait, 'parseOpenGraphMedia', [$openGraphData]);
    ...
    /**
     * Test method [parseOpenGraphMedia] with audios.
     *
     * @return void
     */
    public function testParseOpenGraphMediaAudios()
    {
        $openGraphData = $this->invokeMethod($this->scraper, 'getAllByNamespace', ['og']);
        $this->invokeMethod($this->trait, 'parseOpenGraphMedia', [$openGraphData]);
